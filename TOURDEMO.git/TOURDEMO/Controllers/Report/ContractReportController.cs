                ...
                using (var stream = new MemoryStream())
                {
                    if (form["listItemId"] != null && form["listItemId"] != "")
                    {
                        ...
                        if (listIds.Count() > 0)
                        {
                            ...
                            filename = "[TOURDEMO] Thống kê báo cáo số lượng hợp đồng";
                    ...
                    else
                    {
                        ...
                        filename = "[TOURDEMO] Thống kê báo cáo số lượng hợp đồng từ " + Convert.ToDateTime(form["tungay"]).ToString("dd-MM-yyyy") + " đến " + Convert.ToDateTime(form["denngay"]).ToString("dd-MM-yyyy");
