...
{
    public class EvaluationGuideManageController : BaseController
    {
        ...
        public EvaluationGuideManageController(
        ...
        public ActionResult Search(int guide, int tour)
        {
            var model = _evaluationRepository.GetAllAsQueryable().AsEnumerable()
                           .Where(p => p.StaffId == (guide == 0 ? p.StaffId : guide)
