...
{
    public class EvaluationStaffManageController : BaseController
    {
        ...
        public EvaluationStaffManageController(
        ...
        public ActionResult Search(int _staff, int tour)
        {
            var model = _evaluationRepository.GetAllAsQueryable().AsEnumerable()
                           .Where(p => p.StaffId == (_staff == 0 ? p.StaffId : _staff)
