                ...
                using (var stream = new MemoryStream())
                {
                    if (form["listItemId"] != null && form["listItemId"] != "")
                    {
                        ...
                        if (listIds.Count() > 0)
                        {
                            ...
                            filename = "[TRAVELPLUS] Thống kê báo cáo số lượng tour";
                    ...
                    else
                    {
                        ...
                        filename = "[TRAVELPLUS] Thống kê báo cáo số lượng tour từ " + Convert.ToDateTime(form["tungay"]).ToString("dd-MM-yyyy") + " đến " + Convert.ToDateTime(form["denngay"]).ToString("dd-MM-yyyy");
                        ExportToursToXlsx(stream, tours, filename);
                    }
