...
$("#btnEdit").click(function () {
    ...
    $.ajax({
        type: "POST",
        url: '/EvaluationOperatorManage/Edit',
        data: JSON.stringify(dataPost),
        contentType: "application/json; charset=utf-8",
        dataType: "html",
        success: function (data) {
            $("#edit-evaluation").html(data);
            $("#edit-operator").select2();
            $("#edit-tour").select2();
            $("#edit-area").select2();
...
$("#btnSearch").click(function () {
    var dataPost = {
        _operator: $("#search-operator").val(),
        tour: $("#search-tour").val()
    };
    $.ajax({
        type: "POST",
        url: '/EvaluationOperatorManage/Search',
        data: JSON.stringify(dataPost),
        contentType: "application/json; charset=utf-8",
        dataType: "html",
        success: function (data) {
...
function xoadulieu() {
    ...
    $("table#tableDictionary").delegate("tr", "click", function () {
        ...
        $.ajax({
            type: "POST",
            url: '/EvaluationOperatorManage/Detail',
            data: JSON.stringify(dataPost),
            contentType: "application/json; charset=utf-8",
            dataType: "html",
            success: function (data) {
...
$("#insert-area").change(function () {
    $.getJSON('/EvaluationOperatorManage/ProvinceList?id=' + $('#insert-area').val(), function (data) {
