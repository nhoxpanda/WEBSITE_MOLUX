...
$("#btnEdit").click(function () {
    ...
    $.ajax({
        type: "POST",
        url: '/EvaluationStaffManage/Edit',
...
$("#btnSearch").click(function () {
    var dataPost = {
        _staff: $("#search-staff").val(),
        tour: $("#search-tour").val()
    };
    $.ajax({
        type: "POST",
        url: '/EvaluationStaffManage/Search',
        data: JSON.stringify(dataPost),
        contentType: "application/json; charset=utf-8",
        dataType: "html",
        success: function (data) {
...
function xoadulieu() {
    ...
    $("table#tableDictionary").delegate("tr", "click", function () {
        ...
        $.ajax({
            type: "POST",
            url: '/EvaluationStaffManage/Detail',
            data: JSON.stringify(dataPost),
            contentType: "application/json; charset=utf-8",
            dataType: "html",
            success: function (data) {
...
$("#insert-area").change(function () {
    $.getJSON('/EvaluationStaffManage/ProvinceList?id=' + $('#insert-area').val(), function (data) {
