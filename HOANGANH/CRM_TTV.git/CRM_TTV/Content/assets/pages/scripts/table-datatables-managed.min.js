var TableDatatablesManaged = function () {
    var e = function () {
        ...
        e.find(".group-checkable").change(function () {
            ...
            jQuery(e).each(function () { t ? ($(this).attr("checked", !0), $(this).parents("tr").addClass("active")) : ($(this).attr("checked", !1), $(this).parents("tr").removeClass("active")) }), jQuery.uniform.update(e)
