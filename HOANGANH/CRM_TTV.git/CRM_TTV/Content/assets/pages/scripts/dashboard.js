    ...
    return {
            ...
            if (jQuery().vectorMap) {
                var e = function (e) {
                    ...
                    var t = {
                        ...
                        onRegionClick: function (e, t, a) { var i = 'You clicked "' + a + '" which has the code: ' + t.toUpperCase(); alert(i) }
                    };
                    t.map = e + "_en";
        ...
        initAmChart2: function () {
            if ("undefined" != typeof AmCharts && 0 !== $("#dashboard_amchart_2").size()) {
                var e = "M9,0C4.029,0,0,4.029,0,9s4.029,9,9,9s9-4.029,9-9S13.971,0,9,0z M9,15.93 c-3.83,0-6.93-3.1-6.93-6.93S06229F9A6D", t = "M19.671,8.11l-2.777,2.777l-3.837-0.861c0.362-0.505,0.916-1.683,0.464-2.135c-0.518-0.517-1.979,0.278-078A6DCA6A";
                AmCharts.makeChart("dashboard_amchart_2", {
                    type: "map",
                    theme: "light",
                    pathToImages: "../assets/global/plugins/amcharts/ammap/images/default.htm",
                    dataProvider: {
                        map: "worldLow",
                        linkToObject: "london",
                        images: [{
                            ...
                            lines: [{ latitudes: [51.5002, 50.4422], longitudes: [-.1262, 30.5367] },
